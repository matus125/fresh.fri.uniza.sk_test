...
test('vytvorenie_SK_udalosti', async ({ page }) => {
  ...
  while (!success && attempts < 2) {
    try {
      ...
      await page.getByLabel('Bakalárska').click();
      await page.waitForLoadState('networkidle');
      await page.getByRole('button', { name: 'Uložiť' }).click();
      await expect(titleHelp).toBeHidden({ timeout: 5000 });
      await expect(fromHelp).toBeHidden({ timeout: 5000 });
      await expect(successMsg.nth(5)).toHaveText('Úspešne uložené',  { timeout: 10000});
      await page.getByRole('link', { name: 'Logo Fri Portál FRI' }).click();
      await page.getByText('Študenti').nth(1).click();
      await page.locator('div:nth-child(7) > .ant-row > div:nth-child(2) > .big-menu-navigation > li:nth-child(3) > .menu-content-wrapper > .menu-content > div > .second-level-items-wrapper > div > .cleared-link-component > a').first().click();
      await page.getByRole('button', { name: 'search' }).click();
      await page.getByRole('searchbox').fill('udalost1');
      await page.getByRole('button', { name: 'search' }).nth(1).click();
      await expect(page.locator('text=udalost1')).toHaveCount(1);
      await page.getByLabel('Inžinierske').check();
      await page.waitForLoadState('networkidle');
      await expect(page.locator('text=udalost1')).toHaveCount(0);
      await page.getByLabel('Doktorandské').check();
      await page.waitForLoadState('networkidle');
      await expect(page.locator('text=udalost1')).toHaveCount(0);
      await page.getByLabel('Podujatia').check();
      await page.waitForLoadState('networkidle');
      await expect(page.locator('text=udalost1')).toHaveCount(0);
      await page.getByLabel('Všetky udalost').check();
      await page.waitForLoadState('networkidle');
      await expect(page.locator('text=udalost1')).toHaveCount(1);
...
test('uprava_udalosti', async ({ page }) => {
  let success = false;
  attempts = 0;
  while (!success && attempts < 2) {
    try {
      ...
      await page.getByRole('searchbox').fill('udalost1');
      await page.getByRole('button', { name: 'search' }).nth(1).click();
      await page.getByRole('cell', { name: 'udalost1' }).click();
      await page.getByLabel('Bakalárska').click();
      await page.waitForLoadState('networkidle');
      await page.getByLabel('Inžinierska').click();
      await page.getByRole('button', { name: 'Uložiť' }).click();
      await expect(successMsg.nth(5)).toHaveText('Úspešne uložené',  { timeout: 10000});
      await page.getByRole('link', { name: 'Logo Fri Portál FRI' }).click();
      await page.getByText('Študenti').nth(1).click();
      await page.locator('div:nth-child(7) > .ant-row > div:nth-child(2) > .big-menu-navigation > li:nth-child(3) > .menu-content-wrapper > .menu-content > div:nth-child(2) > .second-level-items-wrapper > div > .cleared-link-component > a').first().click();
      await page.getByRole('button', { name: 'search' }).click();
      await page.getByRole('searchbox').fill('udalost1');
      await page.getByRole('button', { name: 'search' }).nth(1).click();
      await expect(page.locator('text=udalost1')).toHaveCount(1);
      await page.getByLabel('Bakalárske').check();
      await page.waitForLoadState('networkidle');
      await expect(page.locator('text=udalost1')).toHaveCount(0);
      await page.getByLabel('Doktorandské').check();
      await page.waitForLoadState('networkidle');
      ...
      await page.getByLabel('Inžinierska').click();
      await page.waitForLoadState('networkidle');
      await page.getByLabel('Doktorandská').click();
      await page.getByRole('button', { name: 'Uložiť' }).click();
      await expect(successMsg.nth(5)).toHaveText('Úspešne uložené',  { timeout: 10000});
      await page.getByRole('link', { name: 'Logo Fri Portál FRI' }).click();
      await page.getByText('Študenti').nth(1).click();
      await page.locator('div:nth-child(7) > .ant-row > div:nth-child(2) > .big-menu-navigation > li:nth-child(3) > .menu-content-wrapper > .menu-content > div:nth-child(3) > .second-level-items-wrapper > div:nth-child(2) > .cleared-link-component > a').first().click();
      await page.getByRole('button', { name: 'search' }).click();
      await page.getByRole('searchbox').fill('udalost1');
      await page.getByRole('button', { name: 'search' }).nth(1).click();
      await expect(page.locator('text=udalost1')).toHaveCount(1);
      ...
      await page.getByRole('button', { name: 'search' }).nth(1).click();
      await page.getByRole('cell', { name: 'udalost1' }).click();
      await page.getByLabel('Podujatie').click();
      await page.getByRole('button', { name: 'Uložiť' }).click();
      await expect(successMsg.nth(5)).toHaveText('Úspešne uložené',  { timeout: 10000});
      await page.getByRole('link', { name: 'Logo Fri Portál FRI' }).click();
      await page.getByText('Študenti').nth(1).click();
...
test('mazanie_SK_udalosti', async ({ page }) => {
  let success = false;
  attempts = 0;
